...
eval_sst2() {
  hp_policy="$PWD/schedules/sst2_search_all_augm_1500.txt"
  local_dir="$PWD/results/"
  data_path="$PWD/datasets/"
  name="eval_sst2_schedule_1500"
  size=1500
  dataset="sst2"
...
eval_mnlimm() {
  hp_policy="$PWD/schedules/mnli_mm_search_all_augm_1500.txt"
  local_dir="$PWD/results/"
  data_path="$PWD/datasets/"
  name="eval_mnli_mm_schedule_1500"
  size=1500
  dataset="mnli_mm"
