...
class RayModel(Trainable):
    ...
    def _train(self):
        ...
        train_acc, train_matthews, train_f1_score, train_pearson, train_spearman, val_acc, val_matthews, val_f1_score, val_pearson, val_spearman = self.trainer.run_model(self._iteration)
        test_acc, test_matthews, test_f1_score, test_pearson, test_spearman = self.trainer._compute_final_accuracies(self._iteration)  # pylint: disable=protected-access
        return {
            "val_acc": val_acc,
